                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <h5 class="mt-2"><strong id="under_city">{{ trans('file.Frais de livraison') }} : <span style="color: red;">{{ $lims_sale_data->livraison }}</span> DHS</strong></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <input type="hidden" id="livraison" name="livraison" value="{{$lims_sale_data->livraison}}" />
                                ...
                                <div class="row mt-3" style="display: none">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="order_discount" id="order_discount" class="form-control" value="{{$lims_sale_data->order_discount}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
