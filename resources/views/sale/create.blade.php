                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Reference No')}} <span class="required">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.customer')}} <span class="required">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Phone Number')}} <span class="required">*</span></label>
                                            <input type="tel" pattern="0[0-9]{9}" name="customer_tel" id="customer_tel" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.City')}} <span class="required">*</span></label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <label>{{trans('file.Address')}} <span class="required">*</span></label>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <h5>{{trans('file.Order Table')}} <span class="required">*</span></h5>
                                ...
                                <div class="row mt-3" style="display: none">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="order_discount" class="form-control" value="{{ Auth::user()->discount }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
    ...
    $('select[name="customer_city"]').on('change', function() {
        ...
        $.ajax({
            ...
            success:function(data) {
                $("#livraison").val(data);
                $("#under_city").html("{{ trans('file.Frais de livraison') }} : <span style=\"color: red;\">" + data + "</span> DHS");
