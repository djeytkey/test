                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.API ID')}} *</label>
                                        <input type="text" name="api_id" class="form-control" value="@if($lims_general_setting_data){{$lims_general_setting_data->api_id}}@endif" @if(Auth::user()->id !== 1) disabled @endif />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.API KEY')}} *</label>
                                        <input type="text" name="api_key" class="form-control" value="@if($lims_general_setting_data){{$lims_general_setting_data->api_key}}@endif" @if(Auth::user()->id !== 1) disabled @endif/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Montant parrainage')}} *</label>
                                        <input type="number" min="0" name="referral" class="form-control" value="@if($lims_general_setting_data){{$lims_general_setting_data->referral}}@endif" required />
                                    </div>
                                </div>       
                            </div>
                            <div class="form-group">
