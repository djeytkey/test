                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered permission-table role-table">
                                    <thead>
                                        ...
                                        <tr>
                                            <th class="fit text-center">{{ trans('file.View') }}</th>
                                            <th class="fit text-center">{{ trans('file.add') }}</th>
                                            <th class="fit text-center">{{ trans('file.edit') }}</th>
                                            <th class="fit text-center">{{ trans('file.delete') }}</th>
                                            <th class="fit text-center">{{ trans('file.Export Buttons') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {{-- Produits --}}
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('products-export', $all_permission))
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('categories-index', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('categories-add', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('categories-edit', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('categories-delete', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('categories-export', $all_permission))
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('purchases-export', $all_permission))
                                        ...
                                        <tr>
                                            <td>{{ trans('file.Purchase Paiements') }}</td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('purchases-view-paiement', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('purchases-add-paiement', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('purchases-edit-paiement', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('purchases-delete-paiement', $all_permission))
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('sales-export', $all_permission))
                                                        ...
                                                        @else
                                                            <input type="checkbox" value="1" id="sales-export"
                                                                name="sales-export">
                                                        @endif
                                                        <label for="sales-export">{{trans('file.Exports')}}</label>
                                                    </div>
                                                </div>
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('sales-add-discount', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="sales-add-discount">{{ trans('file.Add Discount') }}</label>
                                                    </div>
                                                </div>
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('sales-gen-invoice', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="sales-gen-invoice">{{ trans('file.Generate invoice') }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        {{-- Livraisons --}}
                                        <tr>
                                            <td>{{ trans('file.Delivery') }}</td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('delivery-index', $all_permission))
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('delivery-add', $all_permission))
                                                    ...
                                                    <div class="checkbox">
                                                        ...
                                                        @else
                                                            <input type="checkbox" value="1" id="withdraw-index"
                                                                name="withdraw-index">
                                                        @endif
                                                        <label for="withdraw-index">{{trans('file.Withdraw List')}}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('withdraw-facturation', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="withdraw-facturation">{{trans('file.Facturation')}}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('withdraw-demandes', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="withdraw-demandes">{{ trans('file.Demandes de retrait') }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                    ...
                                                    <div class="checkbox">
                                                        ...
                                                        @else
                                                            <input type="checkbox" value="1" id="withdraw-add"
                                                                name="withdraw-add">
                                                        @endif
                                                        <label for="withdraw-add">{{ trans('file.Demander Un Retrait') }}</label>
                                                    </div>
                                                </div>
                                            </td>                                            
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('withdraw-index-pay', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="withdraw-index-pay">{{ trans('file.Valider paiement') }}</label>
                                                    </div>
                                                </div>
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('withdraw-fact-pay', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="withdraw-fact-pay">{{ trans('file.Valider facture') }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        {{-- Parrains --}}
                                        <tr>
                                            <td>{{ trans('file.Referral') }}</td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('referral-index', $all_permission))
                                                        ...
                                                        @else
                                                            <input type="checkbox" value="1" id="referral-index"
                                                                name="referral-index">
                                                        @endif
                                                        <label for="referral-index">{{trans('file.Referral List')}}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('referral-facturation', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="referral-facturation">{{trans('file.Facturation')}}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('referral-add', $all_permission))
                                                        ...
                                                        @else
                                                            <input type="checkbox" value="1" id="referral-add"
                                                                name="referral-add">
                                                        @endif
                                                        <label for="referral-add">{{ trans('file.Add Referral') }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('referral-index-pay', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="referral-index-pay">{{ trans('file.Valider paiement') }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">                                                
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('referral-fact-pay', $all_permission))
                                                        ...
                                                        @endif
                                                        <label for="referral-fact-pay">{{ trans('file.Valider facture') }}</label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        {{-- <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('expenses-export', $all_permission))
