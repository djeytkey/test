                ...
                <tbody>
                    @foreach ($lims_user_list as $key => $user)
                        <tr data-id="{{ $user->id }}">
                            ...
                            <td>{{ $role->name }}</td>
                            <td>
                                <input type="checkbox" data-id="{{ $user->id }}" data-toggle="toggle" data-size="xs"
                                    data-style="slow" data-on="{{ trans('file.Oui') }}" data-off="{{ trans('file.No') }}" data-onstyle="success" data-offstyle="danger" class="vip-checkbox" value="{{$user->is_vip}}" @if($user->is_vip) checked @endif>
                            </td>
                            @if ($user->is_active)
                                <td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        @if ($user->is_active)
                                            <li>
                                                <a href="{{ route('impersonate', $user->id) }}" class="btn btn-link"><i
