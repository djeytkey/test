                        ...
                        {!! Form::open(['route' => ['user.update', $lims_user_data->id], 'method' => 'put', 'files' => true]) !!}
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="last_name" required class="form-control" value="{{$lims_user_data->last_name}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="first_name" required class="form-control" value="{{$lims_user_data->first_name}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label><strong>{{trans('file.Discount')}}</strong></label>
                                        <input type="number" name="discount" step="0.01" class="form-control" value="{{$lims_user_data->discount}}">
                                    </div>
