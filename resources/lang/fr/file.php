...
return [
	...
	"Returned" => "Retourné",
	"Remaining" => "Reste",
	"Clear Views" => "Effacer Views",
	"Clear Cache" => "Effacer Cache",	
	"Export List" => "Liste d'export",
	"Tickets" => "Réclamations",
	"Ticket List" => "Liste des réclamations",
	"Add Ticket" => "Ajouter réclamation",
	...
	"Products" => "Produits",
	"Remark" => "Remarque",
	"Delivery Status" => "Status livraison",
	"Export" => "Export",
	"Original Price" => "Prix Original",
	"Sales List" => "Liste Ventes",
	"Send Delivery" => "Envoi Livraison",
	"Excel" => "Excel",
	...
	"jours" => "jour(s)",
	"avant de demander un retrait !" => "avant de demander un retrait !",
	"Demander Un Retrait" => "Demander Un Retrait",
	"Demandes de retrait" => "Demandes de retrait",
	"Demander un retrait" => "Demander un retrait",
	"Confirmer votre demande de retrait ?" => "Confirmer votre demande de retrait ?",
	"Referral" => "Parrain",
	"Referral List" => "Liste des parrains",
	"Add Referral" => "Ajouter Parrain",
	"Parrain" => "Parrain",
	"Nombre Vendeurs" => "Nombre Vendeurs",
	"Vendeurs" => "Vendeurs",
	"Invoice Number" => "N° Facture",
	"Montant Total" => "Montant Total",
	"Facture" => "Facture",
	"En Virement" => "En Virement",
	"Payée" => "Payée",
	"Vendeur" => "Vendeur",
	"Gain" => "Gain",
	"Select saler..." => "Sélection vendeur...",
	"Select referral..." => "Sélection parrain...",
	"Payer" => "Payer",
	"Type to search..." => "Tapez pour chercher...",
	"Montant parrainage" => "Montant parrainage",
	"Oui" => "Oui",
	"No" => "Non",
	"VIP" => "VIP",
	"Produit VIP" => "Produit VIP",
