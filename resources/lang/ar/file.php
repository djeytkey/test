...
return [
	...
	"Facturée" => "مفوترة",
	"Validée" => "محققة",
	"Il vous reste" => "بقي لك",
	"jours" => "يوم",
	"avant de demander un retrait !" => "قبل طلب السحب",
	"Demander Un Retrait" => "طلب سحب",
	"Demandes de retrait" => "طلبات السحب",
	"Demander un retrait" => "طلب سحب",
	"Confirmer votre demande de retrait ?" => "تأكيد طلب السحب الخاص بك ؟",
	"Referral" => "كفيل",
	"Referral List" => "لائحة الكفلاء",
	"Add Referral" => "إضافة كفيل",
	"Parrain" => "كفيل",
	"Nombre Vendeurs" => "مجموع البائعين",
	"Vendeurs" => "البائعين",
	"Invoice Number" => "رقم الفاتورة",
	"Montant Total" => "الإجمالي",
	"Facture" => "الفاتورة",
	"En Virement" => "في التحويل",
	"Payée" => "مدفوع",
	"Vendeur" => "البائع",
	"Gain" => "الربح",
	"Select saler..." => "اختر البائع...",
	"Select referral..." => "اختر الكفيل...",
	"Payer" => "ادفع",
	"Type to search..." => "اكتب للبحث...",
	"Montant parrainage" => "مبلغ الكفالة",
	"Oui" => "نعم",
	"No" => "لا",
	"VIP" => "VIP",
	"Produit VIP" => "منتج  VIP",
	"Frais de livraison" => "تكلفة التوصيل",
];
?>