...
return [
	...
	"jours" => "day(s)",
	"avant de demander un retrait !" => "left before requesting a withdrawal",
	"Demander Un Retrait" => "Ask for withdraw",
	"Demandes de retrait" => "Withdraw requests",
	"Demander un retrait" => "Ask for withdraw",
	"Confirmer votre demande de retrait ?" => "Confirm your withdraw request ?",
	"Referral" => "Referral",
	"Referral List" => "Referral List",
	"Add Referral" => "Add Referral",
	"Parrain" => "Referral",
	"Nombre Vendeurs" => "Salers Number",
	"Vendeurs" => "Salers",
	"Invoice Number" => "Invoice Number",
	"Montant Total" => "Total Amount",
	"Facture" => "Invoice",
	"En Virement" => "In transfer",
	"Payée" => "Paid",
	"Vendeur" => "Saler",
	"Gain" => "Profit",
	"Select saler..." => "Select saler...",
	"Select referral..." => "Select referral...",
	"Payer" => "Pay",
	"Type to search..." => "Type to search...",
	"Montant parrainage" => "Referral Amount",
	"Oui" => "Yes",
	"No" => "No",
	"VIP" => "VIP",
	"Produit VIP" => "Product VIP",
