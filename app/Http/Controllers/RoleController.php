...
class RoleController extends Controller
{
    ...
    public function setPermission(Request $request)
    {
        ...
        if($request->has('products-export')){
            $permission = Permission::firstOrCreate(['name' => 'products-export']);
            if(!$role->hasPermissionTo('products-export')){
                $role->givePermissionTo($permission);
            }
        }
        else
        ...
        if($request->has('categories-index')){
            $permission = Permission::firstOrCreate(['name' => 'categories-index']);
            if(!$role->hasPermissionTo('categories-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('categories-index');

        if($request->has('categories-add')){
            $permission = Permission::firstOrCreate(['name' => 'categories-add']);
            if(!$role->hasPermissionTo('categories-add')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('categories-add');

        if($request->has('categories-edit')){
            $permission = Permission::firstOrCreate(['name' => 'categories-edit']);
            if(!$role->hasPermissionTo('categories-edit')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('categories-edit');

        if($request->has('categories-delete')){
            $permission = Permission::firstOrCreate(['name' => 'categories-delete']);
            if(!$role->hasPermissionTo('categories-delete')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('categories-delete');

        if($request->has('categories-export')){
            $permission = Permission::firstOrCreate(['name' => 'categories-export']);
            if(!$role->hasPermissionTo('categories-export')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('categories-export');
        ...
        if($request->has('purchases-export')){
            $permission = Permission::firstOrCreate(['name' => 'purchases-export']);
            if(!$role->hasPermissionTo('purchases-export')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchases-export');

        if($request->has('purchases-view-paiement')){
            $permission = Permission::firstOrCreate(['name' => 'purchases-view-paiement']);
            if(!$role->hasPermissionTo('purchases-view-paiement')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchases-view-paiement');

        if($request->has('purchases-add-paiement')){
            $permission = Permission::firstOrCreate(['name' => 'purchases-add-paiement']);
            if(!$role->hasPermissionTo('purchases-add-paiement')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchases-add-paiement');

        if($request->has('purchases-edit-paiement')){
            $permission = Permission::firstOrCreate(['name' => 'purchases-edit-paiement']);
            if(!$role->hasPermissionTo('purchases-edit-paiement')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchases-edit-paiement');

        if($request->has('purchases-delete-paiement')){
            $permission = Permission::firstOrCreate(['name' => 'purchases-delete-paiement']);
            if(!$role->hasPermissionTo('purchases-delete-paiement')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchases-delete-paiement');
        ...
        if($request->has('sales-export')){
            $permission = Permission::firstOrCreate(['name' => 'sales-export']);
            if(!$role->hasPermissionTo('sales-export')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('sales-export');

        if($request->has('sales-add-discount')){
            $permission = Permission::firstOrCreate(['name' => 'sales-add-discount']);
            if(!$role->hasPermissionTo('sales-add-discount')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('sales-add-discount');

        if($request->has('sales-gen-invoice')){
            $permission = Permission::firstOrCreate(['name' => 'sales-gen-invoice']);
            if(!$role->hasPermissionTo('sales-gen-invoice')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('sales-gen-invoice');        

        if($request->has('delivery-index')){
            $permission = Permission::firstOrCreate(['name' => 'delivery-index']);
            if(!$role->hasPermissionTo('delivery-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('delivery-index');
        
        if($request->has('delivery-add')){
            $permission = Permission::firstOrCreate(['name' => 'delivery-add']);
            if(!$role->hasPermissionTo('delivery-add')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('delivery-add');
        ...
        if($request->has('withdraw-facturation')){
            $permission = Permission::firstOrCreate(['name' => 'withdraw-facturation']);
            if(!$role->hasPermissionTo('withdraw-facturation')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('withdraw-facturation');

        if($request->has('withdraw-demandes')){
            $permission = Permission::firstOrCreate(['name' => 'withdraw-demandes']);
            if(!$role->hasPermissionTo('withdraw-demandes')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('withdraw-demandes');

        if($request->has('withdraw-index-pay')){
            $permission = Permission::firstOrCreate(['name' => 'withdraw-index-pay']);
            if(!$role->hasPermissionTo('withdraw-index-pay')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('withdraw-index-pay');

        if($request->has('withdraw-fact-pay')){
            $permission = Permission::firstOrCreate(['name' => 'withdraw-fact-pay']);
            if(!$role->hasPermissionTo('withdraw-fact-pay')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('withdraw-fact-pay');

        if($request->has('referral-index')){
            $permission = Permission::firstOrCreate(['name' => 'referral-index']);
            if(!$role->hasPermissionTo('referral-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('referral-index');

        if($request->has('referral-add')){
            $permission = Permission::firstOrCreate(['name' => 'referral-add']);
            if(!$role->hasPermissionTo('referral-add')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('referral-add');

        if($request->has('referral-facturation')){
            $permission = Permission::firstOrCreate(['name' => 'referral-facturation']);
            if(!$role->hasPermissionTo('referral-facturation')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('referral-facturation');

        if($request->has('referral-index-pay')){
            $permission = Permission::firstOrCreate(['name' => 'referral-index-pay']);
            if(!$role->hasPermissionTo('referral-index-pay')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('referral-index-pay');

        if($request->has('referral-fact-pay')){
            $permission = Permission::firstOrCreate(['name' => 'referral-fact-pay']);
            if(!$role->hasPermissionTo('referral-fact-pay')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('referral-fact-pay');
