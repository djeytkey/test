...
class SaleController extends Controller
{
    ...
    {
        $lims_city_data = City::where('id', $id)->first();
        if ($lims_city_data->livraison) {
            $livraison_data = $lims_city_data->livraison;
        } else {
            $lims_general_setting_data = GeneralSetting::latest()->first();
            $livraison_data = $lims_general_setting_data->livraison;
        }
